...
// FeesEstimateByIdRequest defines model for FeesEstimateByIdRequest.
...
// GetMyFeesEstimatesErrorList defines model for GetMyFeesEstimatesErrorList.
type GetMyFeesEstimatesErrorList struct {
	Errors []Error `json:"errors"`
}

// GetMyFeesEstimatesRequest defines model for GetMyFeesEstimatesRequest.
type GetMyFeesEstimatesRequest []FeesEstimateByIdRequest

// GetMyFeesEstimatesResponse defines model for GetMyFeesEstimatesResponse.
...
const (
	...
	IdType_SellerSKU IdType = "SellerSKU"
)
...
// GetMyFeesEstimatesJSONBody defines parameters for GetMyFeesEstimates.
type GetMyFeesEstimatesJSONBody GetMyFeesEstimatesRequest
...
// GetMyFeesEstimatesRequestBody defines body for GetMyFeesEstimates for application/json ContentType.
type GetMyFeesEstimatesJSONRequestBody GetMyFeesEstimatesJSONBody
