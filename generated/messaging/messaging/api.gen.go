...
type ClientInterface interface {
	...
	// SendInvoice request  with any body
...
func (c *Client) SendInvoiceWithBody(ctx context.Context, amazonOrderId string, params *SendInvoiceParams, contentType string, body io.Reader) (*http.Response, error) {
	req, err := NewSendInvoiceRequestWithBody(c.Endpoint, amazonOrderId, params, contentType, body)
	if err != nil {
		return nil, err
	}
...
func (c *Client) SendInvoice(ctx context.Context, amazonOrderId string, params *SendInvoiceParams, body SendInvoiceJSONRequestBody) (*http.Response, error) {
	req, err := NewSendInvoiceRequest(c.Endpoint, amazonOrderId, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewSendInvoiceRequest(endpoint string, amazonOrderId string, params *SendInvoiceParams, body SendInvoiceJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewSendInvoiceRequestWithBody(endpoint, amazonOrderId, params, "application/json", bodyReader)
}

// NewSendInvoiceRequestWithBody generates requests for SendInvoice with any type of body
func NewSendInvoiceRequestWithBody(endpoint string, amazonOrderId string, params *SendInvoiceParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/messaging/v1/orders/%s/messages/invoice", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
